...
pub mod variants {
    ...
    pub const V8: LanguageVariant = LanguageVariant::new("v8", LiftingContextFactory::new_v8);
    pub const V8T: LanguageVariant = LanguageVariant::new("v8t", LiftingContextFactory::new_v8t);
}
