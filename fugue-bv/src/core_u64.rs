...
impl BitVec {
    ...
    pub fn from_uint(v: u64, bits: u32) -> Self {
        Self(v, Self::pack_meta(false, bits)).mask()
    }

    pub(crate) fn from_uint_with(v: u64, mask: u64) -> Self {
    ...
    pub(crate) fn mask_value(bits: u32) -> u64 {
        1u64.checked_shl(bits).unwrap_or(0).wrapping_sub(1u64)
    }
    ...
    pub fn count_zeros(&self) -> u32 {
        self.0.count_zeros() - (64 - self.bits())
    }

    pub fn leading_ones(&self) -> u32 {
        (self.0 << (64 - self.bits())).leading_ones()
    }
    ...
    pub fn leading_zeros(&self) -> u32 {
        if self.is_zero() {
            ...
            (self.0 << (64 - self.bits())).leading_zeros()
        }
    }
    ...
    pub fn bit(&self, index: u32) -> bool {
        (self.0 & 1u64.checked_shl(index).unwrap_or(0)) != 0
    }

    pub fn set_bit(&mut self, index: u32) {
        self.0 |= 1u64.checked_shl(index).unwrap_or(0)
    }
    ...
    pub fn from_be_bytes(buf: &[u8]) -> Self {
        if buf.is_empty() || buf.len() > std::mem::size_of::<u64>() {
            panic!(
                "invalid buf size {}; expected size 0 < size <= 8",
                buf.len()
            )
        }
        ...
        tgt[(8 - buf.len())..].copy_from_slice(buf);

        Self::from_uint(u64::from_be_bytes(tgt), bits)
    }
    ...
    pub fn from_le_bytes(buf: &[u8]) -> Self {
        ...
        Self::from_uint(u64::from_le_bytes(tgt), bits)
    }
    ...
    pub fn to_be_bytes(&self, buf: &mut [u8]) {
        ...
        buf.copy_from_slice(&val[(8 - buf.len())..])
    }

    #[inline(always)]
    pub fn to_be_bytes_unchecked(&self, buf: &mut [u8]) {
        let val = self.0.to_be_bytes();
        buf.copy_from_slice(&val[(8 - buf.len())..])
    }
    ...
    #[inline(always)]
    pub fn to_le_bytes_unchecked(&self, buf: &mut [u8]) {
        let val = self.0.to_le_bytes();
        buf.copy_from_slice(&val[..buf.len()])
    }
    ...
    pub fn into_bytes_unchecked<O: Order>(self, bytes: &mut [u8]) {
        if O::ENDIAN.is_big() {
            ...
            self.to_le_bytes_unchecked(bytes)
        }
    }
    ...
    pub fn lcm(&self, rhs: &Self) -> Self {
        ...
        let l = self.signed_cast(64);
        let r = rhs.signed_cast(64);

        Self::from_uint_with((l.0 as i64).lcm(&(r.0 as i64)) as u64, self.mask_bits())
    }
    ...
    pub fn gcd(&self, rhs: &Self) -> Self {
        ...
        Self::from_uint_with((l.0 as i64).gcd(&(r.0 as i64)) as u64, self.mask_bits())
    }
    ...
    pub fn gcd_ext(&self, rhs: &Self) -> (Self, Self, Self) {
        ...
        let ExtendedGcd {
            gcd: g, x: a, y: b, ..
        } = (l.0 as i64).extended_gcd(&(r.0 as i64));
        (
            Self::from_uint_with(g as u64, self.mask_bits()),
            Self::from_uint_with(a as u64, self.mask_bits()),
            Self::from_uint_with(b as u64, self.mask_bits()),
        )
    }
...
impl Mul for BitVec {
    ...
    fn mul(self, rhs: Self) -> Self::Output {
        ...
        Self::from_uint_with(self.0.wrapping_mul(rhs.0), self.mask_bits())
    }
}
...
impl Mul for &BitVec {
    ...
    fn mul(self, rhs: Self) -> Self::Output {
        BitVec::from_uint_with(self.0.wrapping_mul(rhs.0), self.mask_bits())
    }
}
...
mod test {
    ...
    #[test]
    fn test_leading() {
        let a = BitVec::from(0xffu16);

        assert_eq!(0, a.leading_ones());
        assert_eq!(Some(7), a.leading_one());
        assert_eq!(8, a.leading_zeros());
    }
