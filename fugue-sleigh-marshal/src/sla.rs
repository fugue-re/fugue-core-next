...
pub const ELEM_CONST_REAL_NAME: &str = "const_real";
...
pub const ELEM_VARNODE_TPL_NAME: &str = "varnode_tpl";
...
pub const ELEM_CONST_SPACEID_NAME: &str = "const_spaceid";
...
pub const ELEM_CONST_HANDLE_NAME: &str = "const_handle";
...
pub const ELEM_OPERAND_SYM_NAME: &str = "operand_sym";
...
pub const ELEM_OPERAND_SYM_HEAD_NAME: &str = "operand_sym_head";
...
pub const ELEM_COMBINE_PAT_NAME: &str = "combine_pat";
...
pub const ELEM_CONSTRUCTOR_NAME: &str = "constructor";
...
pub const ELEM_CONSTRUCT_TPL_NAME: &str = "construct_tpl";
...
pub const ELEM_VARNODE_SYM_HEAD_NAME: &str = "varnode_sym_head";
...
pub const ELEM_TOKENFIELD_NAME: &str = "tokenfield";
...
pub const ELEM_HANDLE_TPL_NAME: &str = "handle_tpl";
...
pub const ELEM_CONST_RELATIVE_NAME: &str = "const_relative";
...
pub const ELEM_CONTEXT_OP_NAME: &str = "context_op";
...
pub const ELEM_SOURCEFILE_NAME: &str = "sourcefile";
...
pub const ELEM_CONTEXT_SYM_NAME: &str = "context_sym";
...
pub const ELEM_CONTEXT_SYM_HEAD_NAME: &str = "context_sym_head";
...
pub const ELEM_SPACE_OTHER_NAME: &str = "space_other";
...
pub const ELEM_SPACE_UNIQUE_NAME: &str = "space_unique";
...
pub const ELEM_EPSILON_SYM_HEAD_NAME: &str = "epsilon_sym_head";
...
pub const ELEM_SUBTABLE_SYM_NAME: &str = "subtable_sym";
...
pub const ELEM_SUBTABLE_SYM_HEAD_NAME: &str = "subtable_sym_head";
...
pub const ELEM_VALUEMAP_SYM_NAME: &str = "valuemap_sym";
...
pub const ELEM_VALUEMAP_SYM_HEAD_NAME: &str = "valuemap_sym_head";
...
pub const ELEM_VARLIST_SYM_HEAD_NAME: &str = "varlist_sym_head";
...
pub const ELEM_CONST_NEXT_NAME: &str = "const_next";
...
pub const ELEM_CONST_NEXT2_NAME: &str = "const_next2";
...
pub const ELEM_CONST_CURSPACE_NAME: &str = "const_curspace";
...
pub const ELEM_CONST_CURSPACE_SIZE_NAME: &str = "const_curspace_size";
...
pub const ELEM_CONST_FLOWREF_NAME: &str = "const_flowref";
...
pub const ELEM_CONST_FLOWREF_SIZE_NAME: &str = "const_flowref_size";
...
pub const ELEM_CONST_FLOWDEST_NAME: &str = "const_flowdest";
...
pub const ELEM_CONST_FLOWDEST_SIZE_NAME: &str = "const_flowdest_size";
